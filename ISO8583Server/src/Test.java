...
import com.solab.iso8583.CustomField48;
...
public class Test
{
	...
	private static void testTEFMsg() throws Exception
	{
		...
		IsoMessage isoParsedMessage = mf.parseMessage(isoMessage.debugString().getBytes(), 0);
