...
public class IsoMessage {
	...
	public void setBCDMsgType(boolean flag)
	{
		bcdMsgType = flag;
	}
    ...
    public String debugString() {
        ...
        String asciiMsgType = String.format("%04x", type);
        
        if (bcdMsgType)
        {
        	byte[] bcdMsgTypeAux = new byte[2];
        	Bcd.encode(asciiMsgType, bcdMsgTypeAux);
        	sb.append(new String(bcdMsgTypeAux));
        }
        else
        {
        	sb.append(asciiMsgType);
        }
